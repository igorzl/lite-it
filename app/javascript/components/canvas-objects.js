const targetEquip = {
  ...
  '35 mm':
    'https://res.cloudinary.com/dkjjz54zd/image/upload/v1569161829/35_mm_tzzecj.svg',
  'Medium format':
  ...
  Cube:
    'https://res.cloudinary.com/dkjjz54zd/image/upload/v1569161961/cube_lizme3.svg',
  'Work light':
    'https://res.cloudinary.com/dkjjz54zd/image/upload/v1569161961/work_light_wiij1w.svg',
  'Seamless paper':
    'https://res.cloudinary.com/dkjjz54zd/image/upload/v1569161868/seamless_paper_ejuha6.svg',
  Wall:
    'https://res.cloudinary.com/dkjjz54zd/image/upload/v1569161868/wall_e2kqr3.svg',
  Window:
    'https://res.cloudinary.com/dkjjz54zd/image/upload/v1569163434/window_jocv1u.svg'
};
